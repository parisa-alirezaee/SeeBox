...
class BLECentralViewController : UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate{
    ...
    @IBAction func PlayPressed(_ sender: UIButton) {
        //muteNow = (sender.titleLabel?.text == "MUTE")
        writeValue(data: "P")
    }
    ...
    @IBOutlet var VolUpGesture: UISwipeGestureRecognizer!
    @IBAction func VolUpAction(_ sender: UISwipeGestureRecognizer) {
        writeValue(data: "U")
    }
    
    @IBOutlet var VolDownGesture: UISwipeGestureRecognizer!
    @IBAction func VolDownAction(_ sender: UISwipeGestureRecognizer) {
        writeValue(data: "D")
    }
    
    @IBOutlet weak var VolUpButton: UIButton!
    @IBAction func VolUpPressed(_ sender: UIButton) {
        writeValue(data: "U")
    }
    
    @IBOutlet weak var VolDown: UIButton!
    @IBAction func VolDownPressed(_ sender: UIButton) {
        writeValue(data: "D")
    }
...
//    }
    ...
    func centralManager(_ central: CBCentralManager, didDiscover peripheral: CBPeripheral,advertisementData: [String : Any], rssi RSSI: NSNumber) {
        ...
        if blePeripheral == nil {
            ...
            ("Peripheral name: \(String(describing: peripheral.name))")
            print("**********************************")
...
//        navigationController?.pushViewController(uartViewController, animated: true)
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverServices error: Error?) {
        ...
        if ((error) != nil) {
            print("Error discovering services3: \(error!.localizedDescription)")
            return
        }
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverCharacteristicsFor service: CBService, error: Error?) {
        ...
        if ((error) != nil) {
            print("Error discovering services4: \(error!.localizedDescription)")
            return
        }
    ...
    func peripheral(_ peripheral: CBPeripheral, didWriteValueFor characteristic: CBCharacteristic, error: Error?) {
        guard error == nil else {
            print("Error discovering services1: error")
            return
        }
        print("Message sent")
    }
    ...
    func peripheral(_ peripheral: CBPeripheral, didWriteValueFor descriptor: CBDescriptor, error: Error?) {
        guard error == nil else {
            print("Error discovering services2: error")
            return
        }
        print("Succeeded!")
    }
